...
const AutopsyReport = (props) => {
  ...
  const [title, setTitle] = useState('Autopsy Report');
    ...
    <View style={[styles.container, { backgroundColor: '#fff' }]}>
      ...
      >
        ...
        <Text style={{ fontSize: 22, paddingLeft: 15, color: '#000' }}>
          Upload Post Mortem report (PMR)/Autopsy or Viscera report{' '}
        </Text>
      </TouchableOpacity>
      <ScrollView
      ...
      >
        ...
        >
          <Text style={{ color: '#fff', fontWeight: 'bold', fontSize: 18 }}>
            4<Text style={{ fontWeight: 'normal' }}>/5</Text>
          </Text>
        </View>
        <TouchableOpacity
          onPress={() => {
            props.navigation.navigate('IdProofUpload', {
              claimId, Bearer
            });
          }}
          style={styles.footerButton}
